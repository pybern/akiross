...
const attachments = [
  { name: 'car_registration.pdf', href: '#' },
  { name: 'shipping_manifest.pdf', href: '#' },
]
const eventTypes = {
...
const timeline = [
  {
    ...
    target: 'from Melbourne to Brisbane',
    date: 'Sep 20',
    datetime: '2020-09-20',
  },
  {
    ...
    content: 'Quote provided by',
    target: 'instant quote',
    date: 'Sep 20',
    datetime: '2020-09-20',
  },
  {
              ...
              <section aria-labelledby="applicant-information-title">
                <div className="bg-white shadow sm:rounded-lg">
                  <div className="px-4 py-5 sm:px-6">
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">Quote and order information</p>
                  </div>
                  <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                      <div className="sm:col-span-1">
                        <dt className="text-sm font-medium text-gray-500">Booking made for</dt>
                        <dd className="mt-1 text-sm text-gray-900">Melbourne to Perth</dd>
                      </div>
                      <div className="sm:col-span-1">
                      ...
                      <div className="sm:col-span-1">
                        ...
                        <dd className="mt-1 text-sm text-gray-900">$2,000</dd>
                      </div>
                      <div className="sm:col-span-1">
