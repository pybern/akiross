...
import { Bars3CenterLeftIcon, Bars4Icon, ClockIcon, HomeIcon, ChartBarSquareIcon ,XMarkIcon, BeakerIcon } from '@heroicons/react/24/outline'
import {
  ChevronUpDownIcon,
  MagnifyingGlassIcon,
...
const teams = [
  { name: 'Non-car team', href: '#', bgColorClass: 'bg-blue-500' },
  { name: 'BMW team', href: '#', bgColorClass: 'bg-indigo-500' },
  { name: 'Management', href: '#', bgColorClass: 'bg-green-500' },
]
...
export default function Layout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Bookings', href: '/bookings', icon: ClockIcon, current: false },
    { name: 'Quotes', href: '/quotes', icon: Bars4Icon, current: false },
    { name: 'Test', href: '/test', icon: BeakerIcon, current: false },
  ]
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-gray-100 lg:pt-5 lg:pb-4">
          ...
          <div className="mt-6 flex h-0 flex-1 flex-col overflow-y-auto">
            ...
            <Menu as="div" className="relative inline-block px-3 text-left">
              <div>
                <Menu.Button className="group w-full rounded-md bg-gray-100 px-3.5 mt-5 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-100">
                  <span className="flex w-full items-center justify-between">
                    <span className="flex min-w-0 items-center justify-between space-x-3">
                      ...
                      <span className="flex min-w-0 flex-1 flex-col">
                        <span className="truncate text-sm font-medium text-gray-900">Paul Place</span>
                        <span className="truncate text-sm text-gray-500">@pauliemollie</span>
                      </span>
                    </span>
                    <ChevronUpDownIcon
                  ...
                  <Link href={item.href} key={item.name}>
                    <a
                      className={`'text-gray-700 hover:text-gray-900 hover:bg-gray-50 group flex items-center px-2 py-2 text-sm font-medium rounded-md' ${
                        router.asPath === item.href && 'bg-gray-200 text-gray-900' 
                      }`}
                      aria-current={item.current ? 'page' : undefined}
                    >
                      <item.icon
